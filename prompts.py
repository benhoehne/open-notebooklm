...
IMPORTANT RULE: Each line of dialogue should be no more than 200 characters.
...
LENGTH_MODIFIERS = {
    "Short (1-2 min)": "Keep the podcast brief, around 2 minutes long.",
    "Medium (3-5 min)": "Aim for a moderate length, about 5 minutes.",
    "Long (10-12 min)": "Create a comprehensive, in-depth podcast around 12 minutes long with detailed discussions.",
}
